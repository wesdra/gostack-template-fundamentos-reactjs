<img alt="GoStack" src="https://github.com/wesdra/gostack-template-fundamentos-reactjs/blob/master/src/assets/gofinances01.PNG?raw=true" />
<img alt="GoStack" src="https://github.com/wesdra/gostack-template-fundamentos-reactjs/blob/master/src/assets/gofinances02.PNG?raw=true" />
...
Nesse desafio trata-se de uma continuação do desenvolvimento da aplicação de gestão de transações, a GoFinances. O objetivo era praticar o que foi aprendido até agora no React.js junto com TypeScript, utilizando rotas e envio de arquivos por formulário.
...
O desafio foi feito a partir de um modelo que como template do Github.
...
Antes de tudo, para que o frontend se conecte corretamente ao backend, é necessário ir até a pasta do seu backend e execute os comandos yarn add cors e depois yarn add @types/cors -D.

Depois disso ir até o seu app.ts ainda no backend, e importe o cors e adicione app.use(cors()) antes da linha que contém app.use(routes);

Além disso, ter certeza que as informações da categoria, estão sendo retornadas junto com a transação do seu backend no formato como o seguinte:
...
Para isso, foi utilizado a funcionalidade de eager loading do TypeORM, adicionando o seguinte na sua model de transactions:
...
Com o template clonado e pronto para continuar, verificar os arquivos da pasta `src` e completar onde não possui código, com o código para atingir os objetivos de cada rota.
...
Lik do vídeoo explicando o passo a passo para cumprir com todos os requisitos da aplicação:

<a href="https://youtu.be/9YQRZK5mJlw" target="_blank" align="center">
 https://youtu.be/9YQRZK5mJlw
</a>
